...
abstract class Shape {
    ...
    /***********************************
    * Name: draw
    * Description: Draws a Shape. Shapes are drawn after a series of mouse clicks are registered from the user. Usually, a shape requires at least two and at most three clicks. All shapes will be drawn filled in.
    * Params:
    ...
    */
    ...
    /************************************
    * Name: drawFromPoints
    * Description: Draws a Shape from a series of points entered as parameters.The Shape will be drawn filled in.
    * Params:
    ...
    * Returns: An array of points that can be used to redraw this Shape Returned as as list of tuples of integers.
    */
